...
module.exports.UserFailure = {
  ...
  PASSWORD_MISMATCH: "password does not match with old password",
  ...
  UPLOAD: "Please Upload Logo or Image",
  IMAGE: "image type or format should be jpeg",
  NDA_NETWORK: `network issues/something went wrong, try again`,
  HTML: `HTML content cannot be empty`,
  TASK: `unable to perform task`,
}
